                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        if($driver['favorite_driver'] == $row['d_Name']) {
                            echo "<table class='Stats'><tr>";
                                echo "<td><table>";
                                    echo "<tr>
                                        <td><strong>Name: &emsp;</strong></td>
                                        <td>".$row['d_Name']."</td>
                                    </tr>";
                                    echo "<tr>
                                        <td><strong>Number: &emsp;</strong></td>
                                        <td>".$row['d_number']."</td>
                                    </tr>";
                                    echo "<tr>
                                        <td><strong>Date of Birth: &emsp;</strong></td>
                                        <td>".$row['date_of_birth']."</td>
                                    </tr>";
                                    echo "<tr>
                                        <td><strong>Nationality: &emsp;</strong></td>
                                        <td>".$row['nationality']."</td>
                                    </tr>";
                                    echo "<tr>
                                        <td><strong>Team: &emsp;</strong></td>
                                        <td>".$row['t_Name']."</td>
                                    </tr>";
                                echo "</table></td>";                         
...
*/
                ...
                if (mysqli_num_rows($result_t) > 0) {
                    ...
                    $query = "SELECT * FROM Teams WHERE Teams.t_Name='$team'";
                    $result = mysqli_query($dbc, $query);
                    while ($row = mysqli_fetch_array($result)) {
                        if($team == $row['t_Name']) {

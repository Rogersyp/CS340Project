...
<body>
	...
	?>
    <p>Click outside of the password field after entering to see if it matches before submitting.</p>
		...
		<form id="myForm" action="login.php" method="POST">
			<table>
				<tr>
				<th style="text-align:left;">User: </th> <td><input type="text" id="userName" name="userName" /></td>
				</tr>
				<tr>
